...
class Gestor:
    ...
    def cargar(self):
        fichero = open('personajes.pckl', 'ab+')#Append binario, solo de escritura, con el mas para funciones de lectura
        fichero.seek(0)
        try:
    ...
    def guardar(self):
        fichero = open('personajes.pckl', 'wb')#Escritura binaria
